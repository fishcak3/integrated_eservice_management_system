<x-layouts::app :title="__('File Complaint')">
    ...
    {{-- MAIN FORM --}}
    <form id="create-complaint-form" action="{{ route('official.complaints.store') }}" method="POST" class="space-y-10" x-data="{ mode: 'have_account' }">
        @csrf
        ...
        <div class="flex items-center justify-end gap-3 pt-6">
            <flux:button href="{{ route('official.complaints.index', ['type' => 'complaints']) }}" variant="subtle">Cancel</flux:button>
