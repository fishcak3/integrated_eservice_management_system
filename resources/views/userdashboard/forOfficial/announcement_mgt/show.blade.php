    ...
    <div class="flex w-full flex-1 flex-col gap-6 rounded-xl p-0">
        ...
        <flux:card class="p-0 overflow-hidden">
            ...
            <div class="p-6 sm:p-8 space-y-6">
                ...
                <div class="space-y-2">
                    ...
                    <div>
                        ...
                        <flux:subheading>
                            Posted by {{ $announcement->user->name ?? 'Barangay Official' }} 
                        </flux:subheading>
                    </div>
                </div>
            ...
            <div class="bg-zinc-50 dark:bg-zinc-900/50 p-4 flex justify-between items-center border-t border-zinc-200 dark:border-zinc-700">
                ...
                {{-- 🚨 Security Check: Only show if the logged-in user is the creator --}}
                @if($announcement->user_id === auth()->id())
                    <flux:button href="{{ route('official.announcements.edit', $announcement) }}" size="sm" icon="pencil-square">
                        Edit
                    </flux:button>
                @endif
            </div>
