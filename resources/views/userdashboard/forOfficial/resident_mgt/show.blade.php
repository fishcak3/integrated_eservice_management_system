    ...
    <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
        <div class="space-y-2">
            <div class="flex items-center gap-3">
                ...
                @endphp
                <flux:badge rounded :color="$statusColors[$resident->status] ?? 'zinc'" class="capitalize">
                    {{ $resident->status }}
                </flux:badge>
            </div>
        ...
        <flux:button href="{{ route('official.residents.edit', $resident->id) }}" variant="primary" icon="pencil">
            Edit
        </flux:button>            
    </div>
