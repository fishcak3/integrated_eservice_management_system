<x-layouts::app :title="__('Household Details')">
    ...
    <x-slot name="header">
        <flux:breadcrumbs class="mb-2">
            ...
            <flux:breadcrumbs.item href="{{ route('official.residents.household') }}">Households</flux:breadcrumbs.item>
    ...
    <div class="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-start">
        ...
        {{-- <flux:button href="{{ route('official.residents.household.edit', $household->id) }}" variant="primary" icon="pencil">
            Edit Household
        </flux:button> --}}
    </div>
                            ...
                            @forelse ($household->members as $resident)
                                <flux:table.row>
                                    ...
                                    <flux:table.cell align="end">
                                        <flux:button href="{{ route('official.residents.show', $resident->id) }}" size="sm" variant="ghost">
                                            View Profile
                                        </flux:button>
                                    </flux:table.cell>
                                </flux:table.row>
