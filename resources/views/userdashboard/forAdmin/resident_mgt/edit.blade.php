<x-layouts::app :title="__('Edit Resident')">
    ...
    <x-slot name="header">
        <flux:breadcrumbs class="mb-2">
            ...
            <flux:breadcrumbs.item href="{{ route('admin.residents.show', $resident->id) }}">{{ $resident->fname }} {{ $resident->lname }}</flux:breadcrumbs.item>
    ...
    {{-- Form Start --}}
    <form action="{{ route('admin.residents.update', $resident->id) }}" method="POST" class="space-y-10">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-3">
            <div class="px-4 sm:px-0">
                ...
                <flux:text variant="subtle" class="mt-1">
                    Update the resident's basic identifying information, contact details, and current status.
                </flux:text>
            </div>
                ...
                <flux:card class="p-6">
                    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                            <flux:select name="status" label="Account Status" placeholder="Select resident status...">
                                ...
                                <flux:select.option value="transferred" :selected="old('status', $resident->status) == 'transferred'">Transferred</flux:select.option>
        ...
        <div class="flex items-center justify-end gap-4 border-t border-zinc-200 dark:border-zinc-800">
            <flux:button href="{{ route('admin.residents.index') }}" variant="subtle">
                Cancel
            </flux:button>
