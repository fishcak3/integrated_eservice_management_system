<x-layouts::app :title="__('New Request')">
    ...
    {{-- MAIN FORM --}}
    <form id="create-request-form" action="{{ route('admin.documents.store') }}" method="POST" class="space-y-10" x-data="{ mode: 'have_account' }">
        @csrf
        ...
        <div class="flex items-center justify-end gap-3 pt-6">
            <flux:button href="{{ route('admin.documents.index') }}" variant="subtle">Cancel</flux:button>
