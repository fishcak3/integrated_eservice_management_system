<x-layouts::app :title="__('Edit Request')">
    ...
    {{-- Form Start --}}
    <form id="edit-request-form" action="{{ route('admin.documents.update', $documentRequest->id) }}" method="POST" class="space-y-10">
        @csrf
        @method('PUT')
        ...
        <div class="flex items-center justify-end gap-4 pt-6 border-t border-zinc-200 dark:border-zinc-800">
            <flux:button href="{{ route('admin.documents.index') }}" variant="subtle">
                Cancel
            </flux:button>
